...
I just got **Llama 3.2 1B running at 60 tokens/sec on my nucbox mini PC's NPU (Neural Processing Unit)** (AMD Ryzen AI 9 HX 370) under Ubuntu Linux — something that, as far as I can tell, hasn't been publicly demonstrated before.
