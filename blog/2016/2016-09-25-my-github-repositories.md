...
- [luacnn](https://github.com/hpenedones/luacnn) - Convolutional Neural Network for hand digit recognition using Torch7 and Lua.
- [metrics](https://github.com/hpenedones/metrics) - a Torch7 package to compute some metrics, such as area under ROC.
- [lakeml](https://github.com/hpenedones/lakeml) - some Machine Learning algorithms implemented in C++, e.g. AdaBoost, K-means, EM for (diagonal) Gaussian Mixture Models.
