...
[MetaOptimize.com](http://metaoptimize.com) - it contains a great QA about Machine Learning and related topics, using the same web platform [StackOverflow](http://www.stackoverflow.com) has for programming topics.   
...
[Google Predict](http://code.google.com/apis/predict/) : it puts together well established ML algorithms in an API that developers can use to make predictions on their own datasets.